...
namespace
{
	...
	void test_search_roi_out_of_bounds()
	{
		...
		cfg.ball.work_width = 640;
		cfg.ball.work_height = 480;
		cfg.ball.track_search_roi_x = 1000;
		cfg.ball.track_search_roi_y = 1000;
		cfg.ball.track_search_roi_w = 500;
		cfg.ball.track_search_roi_h = 500;
	...
	void test_synthetic_pipe_non_crash()
	{
		...
		cfg.ball.track_search_roi_x = 0;
		cfg.ball.track_search_roi_y = 80;
		cfg.ball.track_search_roi_w = 640;
		cfg.ball.track_search_roi_h = 300;

...
#define ETEST_LOG_DEBUG(source, message)                              \
	::etest::Logger::instance().log(::etest::LogLevel::DEBUG, source, \
	                                message)

#define ETEST_LOG_INFO(source, message)                              \
	::etest::Logger::instance().log(::etest::LogLevel::INFO, source, \
	                                message)

#define ETEST_LOG_WARN(source, message)                              \
	::etest::Logger::instance().log(::etest::LogLevel::WARN, source, \
	                                message)

#define ETEST_LOG_ERROR(source, message)                              \
	::etest::Logger::instance().log(::etest::LogLevel::ERROR, source, \
	                                message)

#define ETEST_LOG_FATAL(source, message)                              \
	::etest::Logger::instance().log(::etest::LogLevel::FATAL, source, \
	                                message)
